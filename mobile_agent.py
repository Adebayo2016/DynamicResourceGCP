...
class File():
    gcp_storage_credentials ='emmanuelMobile_agent.json' #your credentials
    gcp_storage_credentials2 = ''
    path = '/home/adewale/coding/Emmanuel_Service Account/'  
    file2= str(os.path.dirname(path)) + '/' + gcp_storage_credentials
